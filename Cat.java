...
public class Cat extends Animal {
    ...
    public Cat(String name) {
        ...
        super(name, Chase.rNG); // since there's no indication in the instructions that the Cat should have the rNG passed to it, it's taken from Chase.
    }
